...
class PazarPage extends StatefulWidget {
  const PazarPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _PazarPageState createState() => _PazarPageState();
}

class _PazarPageState extends State<PazarPage>
  ...
  void fetchTaskName() async {
    ...
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr1').get();
  ...
  void fetchTaskName2() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr2').get();
  ...
  void fetchTaskName3() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr3').get();
  ...
  void fetchTaskName4() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr4').get();
  ...
  void fetchTaskName5() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr5').get();
  ...
  void fetchTaskName6() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr6').get();
  ...
  void fetchTaskName7() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr7').get();
  ...
  void fetchTaskName8() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('pzr8').get();
