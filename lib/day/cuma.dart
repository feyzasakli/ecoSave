...
class _CumaPageState extends State<CumaPage>
  ...
  void fetchTaskName() async {
    ...
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma1').get();
  ...
  void fetchTaskName2() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma2').get();
  ...
  void fetchTaskName3() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma3').get();
  ...
  void fetchTaskName4() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma4').get();
  ...
  void fetchTaskName5() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma5').get();
  ...
  void fetchTaskName6() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma6').get();
  ...
  void fetchTaskName7() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma7').get();
  ...
  void fetchTaskName8() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    DocumentSnapshot snapshot =
        await firestore.collection('task').doc('cuma8').get();
